...
/**
 * Class to interface Java with the RMath library using the Java Native Application
 * 
 * Need to run Java with the following option <code>-Djna.library.path="bin"</code>
 * 
 * @author carnellr
 */
public class JnaRMath {
     ...
     * @return RNG seeds
     */
    public static native void get_seed(IntByReference seed1, IntByReference seed2);
    ...
    //TODO:  rnbeta is not being found in RMath.dll
